...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section id="about" className="py-20 md:py-32 bg-[#f0eeed] scroll-mt-20 relative overflow-hidden">
      {/* Decorative blobs */}
      <div className="blob top-[10%] right-[-10%] w-[400px] h-[400px] bg-[#002582]/8" />
      <div className="blob bottom-[5%] left-[-8%] w-[380px] h-[380px] bg-sky-300/25" />
      ...
      <div className="relative max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          {tags.map((tag) => {
            ...
            return (
              <div
                key={tag.label}
                className="inline-flex items-center gap-2 bg-white px-4 py-2.5 rounded-full border border-black/10 text-sm md:text-base font-semibold text-black/90 shadow-2xs card-lift hover:border-[#002582]/40 cursor-default"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
          {DENTISTS_DATA.map((doctor, index) => (
            <motion.div
              ...
              className="bg-white rounded-[28px] border border-black/10 p-6 sm:p-8 shadow-sm card-lift hover:shadow-2xl hover:border-[#002582]/25 flex flex-col justify-between group relative overflow-hidden"
            >
              {/* Top accent line */}
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 mb-6 pb-6 border-b border-black/10">
                  <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-2xl overflow-hidden shrink-0 border border-black/10 shadow-md">
                    ...
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-14 h-1 rounded-full bg-[#002582]" />
                  </div>

                  <div>
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#002582] text-white text-xs font-bold shadow-2xs">
        ...
        >
          {stats.map((stat, i) => (
            <div
              key={i}
              className="relative bg-white p-8 rounded-3xl border border-black/10 flex flex-col justify-between hover:border-[#002582]/40 transition-colors shadow-2xs card-lift group overflow-hidden"
            >
              <div className="absolute -right-6 -top-6 w-24 h-24 rounded-full bg-[#002582]/5 group-hover:bg-[#002582]/10 transition-colors" />
              <div className="text-5xl sm:text-6xl lg:text-7xl font-bold text-[#002582] tracking-tight tabular-nums relative">
                <CountUp
                  end={stat.end}
                  suffix={stat.suffix ?? ''}
